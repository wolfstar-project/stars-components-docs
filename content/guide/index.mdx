...
<Tabs groupId="package-manager" persist items={['pnpm', 'npm', 'yarn', 'bun']}>
	<Tab value="pnpm">```bash pnpm create @wolfstar/http-framework my-discord-bot ```</Tab>
	<Tab value="npm">```bash npm create @wolfstar/http-framework@latest my-discord-bot ```</Tab>
	<Tab value="yarn">```bash yarn create @wolfstar/http-framework my-discord-bot ```</Tab>
	<Tab value="bun">```bash bun create @wolfstar/http-framework my-discord-bot ```</Tab>
</Tabs>
...
<Callout type="error">Never commit this file or expose either value in logs.</Callout>
