...
Applies the localized names and descriptions on the builder, calling [applyNameLocalizedBuilder](applyNameLocalizedBuilder) and
[applyDescriptionLocalizedBuilder](applyDescriptionLocalizedBuilder).

## Type Parameters

### T

`T` *extends* [`BuilderWithNameAndDescription`](../type-aliases/BuilderWithNameAndDescription)
