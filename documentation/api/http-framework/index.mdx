...
description: 'Generated API reference for @wolfstar/http-framework: Command and Client namespaces, Register decorators, precondition helpers, and interaction types.'
---
