---
title: 'Function: Enumerable()'
hidden: true
---

> **Enumerable**(`value`): (`target`, `key`) => `void`

Defined in: [packages/http-framework/src/lib/decorators/Enumerable.ts:24](https://github.com/wolfstar-project/stars-components/blob/5aefd164bc5fc41e5a35d3abf908c288163dd354/packages/http-framework/src/lib/decorators/Enumerable.ts#L24)
