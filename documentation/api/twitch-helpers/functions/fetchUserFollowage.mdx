...
> **fetchUserFollowage**(`followerId`, `streamerId`): `Promise`\<`FetchResult`\<[`TwitchHelixResponse`](../interfaces/TwitchHelixResponse)\<[`TwitchHelixUserFollowsResult`](../interfaces/TwitchHelixUserFollowsResult)\> & `object`\>\>
...
`Promise`\<`FetchResult`\<[`TwitchHelixResponse`](../interfaces/TwitchHelixResponse)\<[`TwitchHelixUserFollowsResult`](../interfaces/TwitchHelixUserFollowsResult)\> & `object`\>\>
