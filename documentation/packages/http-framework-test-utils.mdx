...
description: 'Vitest test utilities for the HTTP Framework: createTestHarness wires a TestableClient and InteractionTestRunner around typed interaction fixtures.'
---
