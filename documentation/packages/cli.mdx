---
title: '@wolfstar/cli'
description: 'The stars CLI develops, builds, inspects, and maintains HTTP Framework bots through configurable tsdown, Vite, tsc, and Nitro builders.'
---
...
| `enableNitro`        | Builds through [Nitro](https://nitro.build) v3's Vite plugin (requires `enableVite`) into `.output/` for any Nitro preset |
