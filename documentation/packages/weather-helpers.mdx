...
description: 'Shared weather helpers for Star bots that fetch current conditions, resolve weather names, and convert Celsius to Kelvin or km/h to m/s.'
---
...
<CardGroup cols={2}>
	<Card title="npm" icon="npm" horizontal href="https://npmx.dev/package/@wolfstar/weather-helpers"></Card>
	<Card
		title="Source"
		icon="github"
		horizontal
		href="https://github.com/wolfstar-project/stars-components/tree/main/packages/weather-helpers"
	></Card>
</CardGroup>
