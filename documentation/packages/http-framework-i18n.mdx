...
description: 'Deprecated i18next helpers for the HTTP Framework, superseded by @wolfstar/plugin-i18next. See the migration guide before starting new work.'
---
...
This package has been replaced by [`@wolfstar/plugin-i18next`](/documentation/packages/plugin-i18next). No further releases are planned. See the [migration guide](/documentation/guide/migration).
...
> [migration guide](/documentation/guide/migration#i18next).
