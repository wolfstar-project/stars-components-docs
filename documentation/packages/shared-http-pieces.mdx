...
description: 'Reusable commands and error listeners for Star Networks HTTP-only bots, including Sentry setup and shared invite and repository helpers.'
---
...
<CardGroup cols={2}>
	<Card title="npm" icon="npm" horizontal href="https://npmx.dev/package/@wolfstar/shared-http-pieces"></Card>
	<Card
		title="Source"
		icon="github"
		horizontal
		href="https://github.com/wolfstar-project/stars-components/tree/main/packages/shared-http-pieces"
	></Card>
</CardGroup>
