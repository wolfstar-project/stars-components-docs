...
description: Register chat input, user, and message commands with the HTTP Framework by extending Command and applying RegisterCommand-style decorators.
---
...
[Testing interactions](/documentation/guide/testing) for a complete example.
