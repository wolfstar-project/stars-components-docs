...
- [Generated API reference](/api/index) — built from every public entry point on each documentation build

Browse the full list on the [packages index](/packages/index), or read [Why Stars Components](/guide/why) for the
