...
`ConfigError`/`CliError` by name. See the [configuration error reference](/docs/config/errors) and
[CLI error reference](/docs/cli/errors) for the full code catalogs.
