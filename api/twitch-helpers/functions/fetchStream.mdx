...
> **fetchStream**(`streamerId`): `Promise`\<[`TwitchHelixStreamsResult`](../interfaces/TwitchHelixStreamsResult) \| `null`\>
...
`Promise`\<[`TwitchHelixStreamsResult`](../interfaces/TwitchHelixStreamsResult) \| `null`\>
