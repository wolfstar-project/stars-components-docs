[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / MessageComponentRoleSelectInteraction

# Class: MessageComponentRoleSelectInteraction

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentRoleSelectInteraction.ts:6](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentRoleSelectInteraction.ts#L6)

## theme_extends

- [`MessageComponentInteraction`](MessageComponentInteraction.md)\<[`Type`](../namespaces/MessageComponentRoleSelectInteraction/type-aliases/Type.md)\>

## Constructors

### Constructor

> **new MessageComponentRoleSelectInteraction**(`response`, `data`): `MessageComponentRoleSelectInteraction`
...
[`Type`](../namespaces/MessageComponentRoleSelectInteraction/type-aliases/Type.md)
...
> `protected` `readonly` **\[Data\]**: [`Type`](../namespaces/MessageComponentRoleSelectInteraction/type-aliases/Type.md)
...
[MessageComponentRoleSelectInteraction.keys](#keys).

##### Seealso

[MessageComponentRoleSelectInteraction.values](#values).

##### Seealso

[MessageComponentRoleSelectInteraction.entries](#entries).
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentRoleSelectInteraction`\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentRoleSelectInteraction`\>\>
...
> **deferUpdate**(): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentRoleSelectInteraction`\>\>
...
> **entries**(): `IterableIterator`\<\[`string`, `APIRole`\]\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentRoleSelectInteraction.ts:55](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentRoleSelectInteraction.ts#L55)

Returns an iterator of [ID, Role] pairs.

#### Returns

`IterableIterator`\<\[`string`, `APIRole`\]\>

#### Seealso

[MessageComponentRoleSelectInteraction.roles](#roles).
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentRoleSelectInteraction`\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentRoleSelectInteraction`\>\>
...
> **inGuild**(): `this is InGuild<MessageComponentRoleSelectInteraction>`
...
`this is InGuild<MessageComponentRoleSelectInteraction>`
...
Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentRoleSelectInteraction.ts:30](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentRoleSelectInteraction.ts#L30)
...
[MessageComponentRoleSelectInteraction.ids](#ids).

---

### reply()

> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentRoleSelectInteraction`\>\>
...
> **update**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentRoleSelectInteraction`\>\>
...
> **values**(): `IterableIterator`\<`APIRole`\>
