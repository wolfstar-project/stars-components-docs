[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / MessageComponentUserSelectInteraction

# Class: MessageComponentUserSelectInteraction

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts:6](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts#L6)

## theme_extends

- [`MessageComponentInteraction`](MessageComponentInteraction.md)\<[`Type`](../namespaces/MessageComponentUserSelectInteraction/type-aliases/Type.md)\>

## Constructors

### Constructor

> **new MessageComponentUserSelectInteraction**(`response`, `data`): `MessageComponentUserSelectInteraction`
...
[`Type`](../namespaces/MessageComponentUserSelectInteraction/type-aliases/Type.md)
...
> `protected` `readonly` **\[Data\]**: [`Type`](../namespaces/MessageComponentUserSelectInteraction/type-aliases/Type.md)
...
Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts:10](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts#L10)
...
> **get** **users**(): `Collection`\<`string`, [`User`](../namespaces/TransformedArguments/interfaces/User.md)\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts:21](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts#L21)

Creates a collection with all the selected users.

##### Seealso

[MessageComponentChannelSelectInteraction.keys](MessageComponentChannelSelectInteraction.md#keys).

##### Seealso

[MessageComponentChannelSelectInteraction.values](MessageComponentChannelSelectInteraction.md#values).

##### Seealso

[MessageComponentChannelSelectInteraction.entries](MessageComponentChannelSelectInteraction.md#entries).

##### Returns

`Collection`\<`string`, [`User`](../namespaces/TransformedArguments/interfaces/User.md)\>
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentUserSelectInteraction`\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentUserSelectInteraction`\>\>
...
> **deferUpdate**(): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentUserSelectInteraction`\>\>
...
> **entries**(): `IterableIterator`\<\[`string`, [`User`](../namespaces/TransformedArguments/interfaces/User.md)\]\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts:55](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts#L55)

Returns an iterator of [ID, User] pairs.

#### Returns

`IterableIterator`\<\[`string`, [`User`](../namespaces/TransformedArguments/interfaces/User.md)\]\>

#### Seealso

MessageComponentUserSelectInteraction.channels.

#### Seealso

[MessageComponentUserSelectInteraction.keys](#keys).

#### Seealso

[MessageComponentUserSelectInteraction.values](#values).
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentUserSelectInteraction`\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentUserSelectInteraction`\>\>
...
> **inGuild**(): `this is InGuild<MessageComponentUserSelectInteraction>`
...
`this is InGuild<MessageComponentUserSelectInteraction>`
...
Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts:30](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts#L30)
...
[MessageComponentUserSelectInteraction.ids](#ids).

---

### reply()

> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentUserSelectInteraction`\>\>
...
> **update**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentUserSelectInteraction`\>\>
...
> **values**(): `IterableIterator`\<[`User`](../namespaces/TransformedArguments/interfaces/User.md)\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts:41](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentUserSelectInteraction.ts#L41)

Returns an iterator of the selected users.

#### Returns

`IterableIterator`\<[`User`](../namespaces/TransformedArguments/interfaces/User.md)\>

#### Seealso

[MessageComponentUserSelectInteraction.users](#users).
...
[MessageComponentUserSelectInteraction.entries](#entries).
