[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / MessageComponentInteraction

# Abstract Class: MessageComponentInteraction\<T\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/base/MessageComponentInteraction.ts:29](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/base/MessageComponentInteraction.ts#L29)

## theme_extends

- [`BaseInteraction`](BaseInteraction.md)\<`T`\>

## theme_extended_by

- [`MessageComponentButtonInteraction`](MessageComponentButtonInteraction.md)
- [`MessageComponentChannelSelectInteraction`](MessageComponentChannelSelectInteraction.md)
- [`MessageComponentMentionableSelectInteraction`](MessageComponentMentionableSelectInteraction.md)
- [`MessageComponentRoleSelectInteraction`](MessageComponentRoleSelectInteraction.md)
- [`MessageComponentStringSelectInteraction`](MessageComponentStringSelectInteraction.md)
- [`MessageComponentUserSelectInteraction`](MessageComponentUserSelectInteraction.md)

## Type Parameters

### T

`T` _extends_ [`MessageComponentInteractionType`](../type-aliases/MessageComponentInteractionType.md)

## Constructors

### Constructor

> **new MessageComponentInteraction**\<`T`\>(`response`, `data`): `MessageComponentInteraction`\<`T`\>
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentInteraction`\<`T`\>\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentInteraction`\<`T`\>\>\>

---

### deferUpdate()

> **deferUpdate**(): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentInteraction`\<`T`\>\>\>
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentInteraction`\<`T`\>\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentInteraction`\<`T`\>\>\>

---

### inGuild()

> **inGuild**(): `this is InGuild<MessageComponentInteraction<T>>`
...
`this is InGuild<MessageComponentInteraction<T>>`
...
> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentInteraction`\<`T`\>\>\>
...
> **update**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentInteraction`\<`T`\>\>\>
