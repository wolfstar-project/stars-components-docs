[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / ChatInputCommandInteraction

# Class: ChatInputCommandInteraction

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/ChatInputCommandInteraction.ts:4](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/ChatInputCommandInteraction.ts#L4)

## theme_extends

- [`CommandInteraction`](CommandInteraction.md)\<[`Type`](../namespaces/ChatInputCommandInteraction/type-aliases/Type.md)\>

## Constructors

### Constructor

> **new ChatInputCommandInteraction**(`response`, `data`): `ChatInputCommandInteraction`
...
> `protected` `readonly` **\[Data\]**: `APIChatInputApplicationCommandInteraction`
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`ChatInputCommandInteraction`\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`ChatInputCommandInteraction`\>\>
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`ChatInputCommandInteraction`\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`ChatInputCommandInteraction`\>\>
...
> **inGuild**(): `this is InGuild<ChatInputCommandInteraction>`
...
`this is InGuild<ChatInputCommandInteraction>`
...
> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`ChatInputCommandInteraction`\>\>
