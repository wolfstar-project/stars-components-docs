[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / MessageComponentStringSelectInteraction

# Class: MessageComponentStringSelectInteraction

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentStringSelectInteraction.ts:4](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentStringSelectInteraction.ts#L4)

## theme_extends

- [`MessageComponentInteraction`](MessageComponentInteraction.md)\<[`Type`](../namespaces/MessageComponentStringSelectInteraction/type-aliases/Type.md)\>

## Constructors

### Constructor

> **new MessageComponentStringSelectInteraction**(`response`, `data`): `MessageComponentStringSelectInteraction`
...
[`Type`](../namespaces/MessageComponentStringSelectInteraction/type-aliases/Type.md)
...
> `protected` `readonly` **\[Data\]**: [`Type`](../namespaces/MessageComponentStringSelectInteraction/type-aliases/Type.md)
...
Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentStringSelectInteraction.ts:5](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentStringSelectInteraction.ts#L5)
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentStringSelectInteraction`\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentStringSelectInteraction`\>\>
...
> **deferUpdate**(): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentStringSelectInteraction`\>\>
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentStringSelectInteraction`\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentStringSelectInteraction`\>\>
...
> **inGuild**(): `this is InGuild<MessageComponentStringSelectInteraction>`
...
`this is InGuild<MessageComponentStringSelectInteraction>`
...
> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentStringSelectInteraction`\>\>
...
> **update**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentStringSelectInteraction`\>\>
