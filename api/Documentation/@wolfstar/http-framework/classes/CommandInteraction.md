[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / CommandInteraction

# Class: CommandInteraction\<T\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/base/CommandInteraction.ts:29](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/base/CommandInteraction.ts#L29)
...
- [`MessageContextMenuCommandInteraction`](MessageContextMenuCommandInteraction.md)
- [`UserContextMenuCommandInteraction`](UserContextMenuCommandInteraction.md)

## Type Parameters

### T

`T` _extends_ [`BaseCommandInteractionType`](../type-aliases/BaseCommandInteractionType.md)

## Constructors

### Constructor

> **new CommandInteraction**\<`T`\>(`response`, `data`): `CommandInteraction`\<`T`\>
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`CommandInteraction`\<`T`\>\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`CommandInteraction`\<`T`\>\>\>
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`CommandInteraction`\<`T`\>\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`CommandInteraction`\<`T`\>\>\>

---

### inGuild()

> **inGuild**(): `this is InGuild<CommandInteraction<T>>`
...
`this is InGuild<CommandInteraction<T>>`
...
> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`CommandInteraction`\<`T`\>\>\>
