[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / MessageComponentChannelSelectInteraction

# Class: MessageComponentChannelSelectInteraction

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts:6](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts#L6)

## theme_extends

- [`MessageComponentInteraction`](MessageComponentInteraction.md)\<[`Type`](../namespaces/MessageComponentChannelSelectInteraction/type-aliases/Type.md)\>

## Constructors

### Constructor

> **new MessageComponentChannelSelectInteraction**(`response`, `data`): `MessageComponentChannelSelectInteraction`
...
[`Type`](../namespaces/MessageComponentChannelSelectInteraction/type-aliases/Type.md)
...
> `protected` `readonly` **\[Data\]**: [`Type`](../namespaces/MessageComponentChannelSelectInteraction/type-aliases/Type.md)
...
> **get** **channels**(): `Collection`\<`string`, `APIInteractionDataResolvedChannel`\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts:21](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts#L21)

Creates a collection with all the selected channels.

##### Seealso

[MessageComponentChannelSelectInteraction.keys](#keys).

##### Seealso

[MessageComponentChannelSelectInteraction.values](#values).

##### Seealso

[MessageComponentChannelSelectInteraction.entries](#entries).
...
Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts:10](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts#L10)
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentChannelSelectInteraction`\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentChannelSelectInteraction`\>\>
...
> **deferUpdate**(): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentChannelSelectInteraction`\>\>
...
> **entries**(): `IterableIterator`\<\[`string`, `APIInteractionDataResolvedChannel`\]\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts:55](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts#L55)

Returns an iterator of [ID, Channel] pairs.

#### Returns

`IterableIterator`\<\[`string`, `APIInteractionDataResolvedChannel`\]\>

#### Seealso

[MessageComponentChannelSelectInteraction.channels](#channels).
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentChannelSelectInteraction`\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentChannelSelectInteraction`\>\>
...
> **inGuild**(): `this is InGuild<MessageComponentChannelSelectInteraction>`
...
`this is InGuild<MessageComponentChannelSelectInteraction>`
...
Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts:30](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts#L30)
...
[MessageComponentChannelSelectInteraction.ids](#ids).

---

### reply()

> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentChannelSelectInteraction`\>\>
...
> **update**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentChannelSelectInteraction`\>\>
...
> **values**(): `IterableIterator`\<`APIInteractionDataResolvedChannel`\>

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts:41](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentChannelSelectInteraction.ts#L41)

Returns an iterator of the selected channels.

#### Returns

`IterableIterator`\<`APIInteractionDataResolvedChannel`\>
