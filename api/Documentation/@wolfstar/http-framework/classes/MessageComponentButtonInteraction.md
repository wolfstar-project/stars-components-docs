[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / MessageComponentButtonInteraction

# Class: MessageComponentButtonInteraction

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentButtonInteraction.ts:4](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/MessageComponentButtonInteraction.ts#L4)

## theme_extends

- [`MessageComponentInteraction`](MessageComponentInteraction.md)\<[`Type`](../namespaces/MessageComponentButtonInteraction/type-aliases/Type.md)\>

## Constructors

### Constructor

> **new MessageComponentButtonInteraction**(`response`, `data`): `MessageComponentButtonInteraction`
...
> `protected` `readonly` **\[Data\]**: `APIMessageComponentButtonInteraction`
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentButtonInteraction`\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentButtonInteraction`\>\>
...
> **deferUpdate**(): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentButtonInteraction`\>\>
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentButtonInteraction`\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`MessageComponentButtonInteraction`\>\>
...
> **inGuild**(): `this is InGuild<MessageComponentButtonInteraction>`
...
`this is InGuild<MessageComponentButtonInteraction>`
...
> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentButtonInteraction`\>\>
...
> **update**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`MessageComponentButtonInteraction`\>\>
