[@wolfstar/website](../../../../index.md) / [Documentation](../../../index.md) / [@wolfstar/http-framework](../index.md) / UserContextMenuCommandInteraction

# Class: UserContextMenuCommandInteraction

Defined in: [packages/http-framework/src/lib/interactions/structures/interactions/UserContextMenuCommandInteraction.ts:4](https://github.com/wolfstar-project/stars-components/blob/f7b31cc0eb5f9a284e64590e28eadbf470e88f64/packages/http-framework/src/lib/interactions/structures/interactions/UserContextMenuCommandInteraction.ts#L4)

## theme_extends

- [`CommandInteraction`](CommandInteraction.md)\<[`Type`](../namespaces/UserContextMenuCommandInteraction/type-aliases/Type.md)\>

## Constructors

### Constructor

> **new UserContextMenuCommandInteraction**(`response`, `data`): `UserContextMenuCommandInteraction`
...
> `protected` `readonly` **\[Data\]**: `APIUserApplicationCommandInteraction`
...
> **defer**(`data?`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`UserContextMenuCommandInteraction`\>\>
...
`Promise`\<[`PartialMessage`](PartialMessage.md)\<`UserContextMenuCommandInteraction`\>\>
...
> **followup**(`data`): [`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`UserContextMenuCommandInteraction`\>\>
...
[`AsyncDiscordResult`](../type-aliases/AsyncDiscordResult.md)\<[`Message`](Message.md)\<`UserContextMenuCommandInteraction`\>\>
...
> **inGuild**(): `this is InGuild<UserContextMenuCommandInteraction>`
...
`this is InGuild<UserContextMenuCommandInteraction>`
...
> **reply**(`data`): `Promise`\<[`PartialMessage`](PartialMessage.md)\<`UserContextMenuCommandInteraction`\>\>
