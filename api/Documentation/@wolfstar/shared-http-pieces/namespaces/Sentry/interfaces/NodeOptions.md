[@wolfstar/website](../../../../../../index.md) / [Documentation](../../../../../index.md) / [@wolfstar/shared-http-pieces](../../../index.md) / [Sentry](../index.md) / NodeOptions
...
- `CoreOptions`\<`NodeTransportOptions`\>.`BaseNodeOptions`
...
> `optional` **beforeSendMetric?**: (`metric`) => [`Metric`](Metric.md) \| `null`
...
This is the opposite of [CoreOptions.denyUrls](../../../interfaces/SentryOptions.md#denyurls).
...
> `optional` **beforeBreadcrumb?**: (`breadcrumb`, `hint?`) => [`Breadcrumb`](Breadcrumb.md) \| `null`
...
[`BreadcrumbHint`](BreadcrumbHint.md)

#### Returns

[`Breadcrumb`](Breadcrumb.md) \| `null`
...
> `optional` **beforeSend?**: (`event`, `hint`) => [`ErrorEvent`](ErrorEvent.md) \| `PromiseLike`\<[`ErrorEvent`](ErrorEvent.md) \| `null`\> \| `null`
...
[`ErrorEvent`](ErrorEvent.md) \| `PromiseLike`\<[`ErrorEvent`](ErrorEvent.md) \| `null`\> \| `null`
...
> `optional` **beforeSendLog?**: (`log`) => [`Log`](Log.md) \| `null`
...
When using `traceLifecycle: 'stream'`, wrap your callback with [withStreamedSpan](../functions/withStreamedSpan.md)
...
`BaseNodeOptions.clientReportFlushInterval`
...
To allow certain errors instead, use [CoreOptions.allowUrls](../../../interfaces/SentryOptions.md#allowurls).
By default, all errors will be sent.
...
`BaseNodeOptions.disableInstrumentationWarnings`
...
Defined in: node_modules/.pnpm/@sentry+core@10.71.0/node_modules/@sentry/core/build/types/types/options.d.ts:188
...
`Options.enhanceFetchErrorMessages`
...
`BaseNodeOptions.includeServerName`

---

### initialScope?

> `optional` **initialScope?**: [`CaptureContext`](../type-aliases/CaptureContext.md)
...
`BaseNodeOptions.maxSpanWaitDuration`
...
`BaseNodeOptions.openTelemetryBasicTracerProvider`
...
`BaseNodeOptions.openTelemetryInstrumentations`
...
[OpenTelemetryServerRuntimeOptions.openTelemetryBasicTracerProvider](#opentelemetrybasictracerprovider).

#### Inherited from

`BaseNodeOptions.openTelemetrySpanProcessors`
...
`BaseNodeOptions.profileLifecycle`
...
`BaseNodeOptions.profileSessionSampleRate`
...
in addition to the `sentry-trace` and `baggage` headers. Use the [CoreOptions.tracePropagationTargets](../../../interfaces/SentryOptions.md#tracepropagationtargets)
...
`BaseNodeOptions.registerEsmLoaderHooks`
...
`BaseNodeOptions.shutdownTimeout`
...
`BaseNodeOptions.skipOpenTelemetrySetup`
