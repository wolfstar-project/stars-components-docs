...
When the fallback is omitted, a [`PreconditionError`](../classes/PreconditionError) identified by
[`Identifiers.PreconditionClientPermissions`](../enumerations/Identifiers#preconditionclientpermissions) is thrown, which the client emits as `commandError` (or
