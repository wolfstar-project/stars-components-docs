...
<CardGroup cols={2}>
  <Card title="npm" icon="npm" horizontal href="https://npmx.dev/package/@wolfstar/plugin-i18next">
  </Card>
  <Card title="Source" icon="github" horizontal href="https://github.com/wolfstar-project/plugins/tree/main/packages/plugin-i18next">
  </Card>
</CardGroup>

<Tip>
Coming from `@wolfstar/http-framework-i18n`? Follow the [migration guide](/guide/migration).
</Tip>
